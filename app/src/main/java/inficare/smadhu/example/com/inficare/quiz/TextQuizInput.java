...
public class TextQuizInput extends AppCompatActivity {
    TextView questionLabel, questionCountLabel, scoreLabel;
    EditText answerEdt;
    Button submitButton;
    ProgressBar progressBar;
    private ArrayList<Quiz.QuestionModel> questionModelArraylist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_text_quiz_input);
    ...
    public void checkAnswer(){
        ...
        if(answerString.equalsIgnoreCase(questionModelArraylist.get(currentPosition).getAnswer())){
            ...
            new SweetAlertDialog(TextQuizInput.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(TextQuizInput.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void setUpQuestion(){
        ...
        questionModelArraylist.add(new Quiz.QuestionModel("What is 1+2 ? ","3"));
        questionModelArraylist.add(new Quiz.QuestionModel("What is 8*8 ? ","64"));
        questionModelArraylist.add(new Quiz.QuestionModel("What is 9*12 ? ","108"));
        questionModelArraylist.add(new Quiz.QuestionModel("What is 6*8 ? ","48"));
        questionModelArraylist.add(new Quiz.QuestionModel("What is 12/3 ? ","4"));
